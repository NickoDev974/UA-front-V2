      ...
      <Router basename="/UA-front-V2">
        ...
        <Routes>
          ...
          <Route
            path="/storePaul"
            element={
              <RequireAuth child={StorePaul} auth={false} admin={false} />
            }
          />{" "}
          <Route
            path="/storeMarie"
          ...
          <Route
            path="/addProduct"
            element={
              <RequireAuth child={AddProduct} auth={true} admin={true} />
            }
          />
          <Route
            path="/editProduct/:id"
            element={
              <RequireAuth child={EditProduct} auth={true} admin={true} />
            }
          />
          <Route
            path="/addCategory"
            element={
              <RequireAuth child={AddCategory} auth={true} admin={true} />
            }
          />
          <Route
            path="/basket"
          ...
          <Route
            path="/orderDetail/:id"
            element={
              <RequireAuth child={OrderDetail} auth={true} admin={true} />
            }
          />
